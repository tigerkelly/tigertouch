...
//	private AgGlobal ag = AgGlobal.getInstance();
     ...
     */
	public static final String SCENENAV    			= "SceneNav.fxml";
	public static final String MAINSTAGE   			= "MainStage.fxml";
	public static final String STAGE1   			= "Stage1.fxml";
	public static final String STAGE2   			= "Stage2.fxml";
	public static final String STAGE3   			= "Stage3.fxml";
	public static final String STAGE4   			= "Stage4.fxml";
...
//			String pn = this.sceneQue.peek();
//			if (pn.equals(SceneNav.KEYBOARD))
//				kbReturn = true;
...
//		}
		...
		if (this.sceneQue != null && this.sceneQue.empty() == false) {
			...
			if (this.sceneQue.empty() == false) {
				...
				this.loadScene(SceneNav.MAINSTAGE);
			}
		}
	}
    ...
    public void gotoMainMenu() {
    	if (this.sceneQue != null && this.sceneQue.empty() == false) {
    		while(true) {
    			...
    			if (fxml.equals(SceneNav.MAINSTAGE) == true)
    				break;
