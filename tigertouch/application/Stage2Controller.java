...
public class Stage2Controller implements Initializable, RefreshScene {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
    	stage2Pane.setCursor(Cursor.NONE);
		robot = new Robot();
		robot.mouseMove(0, 0);
        ...
        assert stage2Pane != null : "fx:id=\"stage2Pane\" was not injected: check your FXML file 'Stage2.fxml'.";
        assert btnRetMain != null : "fx:id=\"btnRetMain\" was not injected: check your FXML file 'Stage2.fxml'.";

    }

	@Override
	public void refreshScene() {
		System.out.println("Refreshing Stage 2");
	}

	@Override
	public void leaveScene() {
		System.out.println("Leaving Stage 2");
	}
